...
def get_common_gov(pageBegin: int, pageEnd: int) -> list:
    ...
    for i in tqdm(range(pageBegin, pageEnd + 1)):
        ...
        url = f"https://www.jms.gov.cn/html/index/page/000100050001_{i}.html"
        # 发起请求
        ...
        element_a_text = html.xpath('//ul[@class="jms_listUl"]//a/text()')
        # TODO：替换成实际词条的href属性
        # element_a_href = html.xpath('//*[@id="resources"]/li/a/@href')
        element_a_href = html.xpath('//ul[@class="jms_listUl"]//a/@href')
        # TODO：替换成实际日期的xpath路径
        # element_span = html.xpath('//*[@id="resources"]/li/span/text()')
        element_span = html.xpath('//ul[@class="jms_listUl"]//span/text()')
