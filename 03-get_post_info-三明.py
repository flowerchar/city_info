...
# TODO：这里填上具体城市的防盗链
headers = {'Referer': 'https://www.sm.gov.cn/zw/zwxx/sjdt/'}
...
def post_implicit_gov(pageBegin: int, pageEnd: int) -> list:
    ...
    url = f"https://www.sm.gov.cn/fjdzapp/data?channelid=100000&sortfield=-docorderpri%2C-docreltime&classsql=chnlid%3D4064&classcol=publishyear&classnum=100&classsort=0&cache=true&page=133&prepage=75"
    # 发起请求
