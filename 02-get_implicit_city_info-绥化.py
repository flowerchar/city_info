...
import random
# TODO：这里填上具体城市的防盗链
headers = {'Referer': 'https://www.suihua.gov.cn/sh/bdyw/list0.shtml',
...
def get_implicit_gov(pageBegin: int, pageEnd: int) -> list:
    ...
    for i in tqdm(range(pageBegin, pageEnd + 1)):
        ...
        url = f"https://www.suihua.gov.cn/common/search/e36ffbfe495f4a0db59f42ec77464c21?_isAgg=true&_isJson=true&_pageSize=15&_template=index&_rangeTimeGte=&_channelName=&page={i}"
        # 发起请求
...
# TODO：填写具体的起止页
data1 = get_implicit_gov(66,96)
# 过滤非2018的数据
data2 = filter_by_time(data1)
# TODO：写全文件名，保存到csv
keep2csv("黑龙江-绥化", data2)