...
import random
# TODO：这里填上具体城市的防盗链
headers = {'Referer': 'https://www.tls.gov.cn/newtlsrmzf/c104406/list.shtml',
...
def get_implicit_gov(pageBegin: int, pageEnd: int) -> list:
    ...
    for i in tqdm(range(pageBegin, pageEnd + 1)):
        ...
        url = f"https://www.tls.gov.cn/common/search/ae6eae9dcf5f4c04a79ed194ee9e5df3?_isAgg=false&_isJson=true&_pageSize=15&_template=index&_rangeTimeGte=&_channelName=&page={i}"
        # 发起请求
...
# TODO：填写具体的起止页
data1 = get_implicit_gov(68,94)
# 过滤非2018的数据
data2 = filter_by_time(data1)
# TODO：写全文件名，保存到csv
keep2csv("伊春-铁力", data2)