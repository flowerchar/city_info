...
def get_common_gov(pageBegin: int, pageEnd: int) -> list:
    ...
    for i in tqdm(range(pageBegin, pageEnd + 1)):
        ...
        url = f"https://www.dongning.gov.cn/index.php/cms/item-list-category-1302-page-{i}.shtml"
        # 发起请求
        ...
        element_a_text = html.xpath('//div[@class="main"]//a/text()')
        # TODO：替换成实际词条的href属性
        # element_a_href = html.xpath('//*[@id="resources"]/li/a/@href')
        element_a_href = html.xpath('//div[@class="main"]//a/@href')
