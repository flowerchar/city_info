...
import random
# TODO：这里填上具体城市的防盗链
headers = {'Referer': 'http://www.ycjl.gov.cn/jlqrmzf/c100545/list.shtml',
...
def get_implicit_gov(pageBegin: int, pageEnd: int) -> list:
    ...
    for i in tqdm(range(pageBegin, pageEnd + 1)):
        ...
        url = f"http://www.ycjl.gov.cn/common/search/57872cb582aa49509c23e3864419be6f?_isAgg=false&_isJson=true&_pageSize=15&_template=index&_rangeTimeGte=&_channelName=&page={i}"
        # 发起请求
...
# TODO：填写具体的起止页
data1 = get_implicit_gov(75,138)
# 过滤非2018的数据
data2 = filter_by_time(data1)
# TODO：写全文件名，保存到csv
keep2csv("伊春-金林", data2)